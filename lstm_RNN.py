...
# Path to the dataset files on disk.
target_data_path = "json-valid.txt"
input_data_path = "json-invalid.txt"
...
with open(input_data_path, 'r') as input_f:
...
with open(target_data_path, 'r') as target_f:
    target_lines = target_f.read().split("\n")
...
for i, (input_data, target_data) in enumerate(zip(input_texts, target_texts)):
